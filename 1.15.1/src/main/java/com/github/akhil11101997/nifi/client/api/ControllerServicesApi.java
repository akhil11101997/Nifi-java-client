...
import com.github.akhil11101997.nifi.client.model.ComponentStateEntity;
import com.github.akhil11101997.nifi.client.model.ConfigurationAnalysisEntity;
import com.github.akhil11101997.nifi.client.model.ControllerServiceEntity;
import com.github.akhil11101997.nifi.client.model.ControllerServiceReferencingComponentsEntity;
import com.github.akhil11101997.nifi.client.model.ControllerServiceRunStatusEntity;
import com.github.akhil11101997.nifi.client.model.PropertyDescriptorEntity;
import com.github.akhil11101997.nifi.client.model.UpdateControllerServiceReferenceRequestEntity;
import com.github.akhil11101997.nifi.client.model.VerifyConfigRequestEntity;
...
public class ControllerServicesApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteValidationRequestCall(String id, String requestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteValidationRequestValidateBeforeCall(String id, String requestId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (requestId == null) {
            throw new ApiException("Missing the required parameter 'requestId' when calling deleteValidationRequest(Async)");
        }
        

        com.squareup.okhttp.Call call = deleteValidationRequestCall(id, requestId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public VerifyConfigRequestEntity deleteValidationRequest(String id, String requestId) throws ApiException {
        ApiResponse<VerifyConfigRequestEntity> resp = deleteValidationRequestWithHttpInfo(id, requestId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<VerifyConfigRequestEntity> deleteValidationRequestWithHttpInfo(String id, String requestId) throws ApiException {
        com.squareup.okhttp.Call call = deleteValidationRequestValidateBeforeCall(id, requestId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteValidationRequestAsync(String id, String requestId, final ApiCallback<VerifyConfigRequestEntity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteValidationRequestValidateBeforeCall(id, requestId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VerifyConfigRequestEntity>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
