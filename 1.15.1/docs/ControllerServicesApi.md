...
//import com.github.akhil11101997.nifi.client.api.ControllerServicesApi;
...
> VerifyConfigRequestEntity deleteValidationRequest(id, requestId)
...
try {
    VerifyConfigRequestEntity result = apiInstance.deleteValidationRequest(id, requestId);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling ControllerServicesApi#deleteValidationRequest");
    e.printStackTrace();
}
```
